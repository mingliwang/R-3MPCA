function Jm = algStep1vc(Nm, stdGlb, patSize, nbhRad, simNum, balDiv, RmIndP, rptNbhRC, rptNbhP)
%ALGSTEP1VC Summary of this function goes here
...
for kp = 1: Kp
    ...
    [uptInRom, prsInRom] = MPCAvcf(stdGlb, ptsInRom, simIndNbh, patSize, simNum, balDiv);
